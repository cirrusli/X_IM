...
//should first create the databases in the MySQL:
//
// create database x_base default character set utf8mb4 collate utf8mb4_unicode_ci;
// create database x_message default character set utf8mb4 collate utf8mb4_unicode_ci;
